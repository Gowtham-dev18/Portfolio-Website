...
function EmailButton() {
  ...
  return (
    ...
    >
      {copied ? (
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true" className="text-emerald-400">
          <path
            d="M20 6L9 17l-5-5"
            stroke="currentColor"
            strokeWidth="2.5"
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Right side: GitHub, LinkedIn Icons */}
      <div className="fixed top-5 right-28 z-50 flex items-center gap-3 mt-1.5">
        {/* GitHub */}
        <a
          href={GITHUB}
          target="_blank"
